...
{
    public partial class frmUvoz_u_Program : Form
    {
        public frmUvoz_u_Program()
        {
            InitializeComponent();
        }
        ...
        private void btnLoadXml_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog1.Filter = "Excel files (*.xml)|*.xml|All files (*.*)|*.*";
            saveFileDialog1.FilterIndex = 1;
            saveFileDialog1.FileName = "artikli.xml";
        ...
        private void loadXML(string path)
        {
            ...
            try
            {
                ds.ReadXml(fsReadXml, XmlReadMode.InferSchema);
            }
            catch (Exception ex)
            {
