    ...
    public partial class frmSveIzdatnice : Form
    {
        ...
        private void fillDataGrid_stavke(string broj)
        {
            try
            {
                ...
                string sql = "SELECT izdatnica_stavke.broj AS [Broj Izdatnice],izdatnica_stavke.sifra as [Sifra] " +
                    " ,izdatnica_stavke.nbc as [NBC], izdatnica_stavke.kolicina as [Količina], izdatnica_stavke.vpc as [VPC], " +
                    " izdatnica_stavke.mpc as [MPC], izdatnica_stavke.rabat as [Rabat], izdatnica_stavke.pdv as [Porez], " +
                    " izdatnica_stavke.ukupno as [Ukupno] " +
                    " FROM izdatnica_stavke " +
                    " LEFT JOIN izdatnica ON izdatnica.id_izdatnica = izdatnica_stavke.id_izdatnica " +
                    " WHERE izdatnica_stavke.id_izdatnica = '" + broj + "' " +
                    " ORDER BY izdatnica_stavke.sifra DESC";
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    Partner = "izdatnica.id_partner='" + cbPartner.SelectedValue + "' AND ";
            //}
            ...
            string sql = "SELECT DISTINCT " + top + " izdatnica.broj AS [Broj izdatnice], izdatnica.id_skladiste AS [Broj skladista]," +
                ...
                " ORDER BY izdatnica.datum DESC" + remote;
