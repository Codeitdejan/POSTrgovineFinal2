...
namespace PCPOS
{
    public partial class frmPonude : Form
    {
        ...
        private void numeric()
        {
            ...
            nmGodinaPonude.Value = Convert.ToInt16(DateTime.Now.Year.ToString());
            ;
        }
        ...
        private void EnableDisable(bool x)
        {
            ...
            ttxBrojPonude.ReadOnly = x;
            nmGodinaPonude.ReadOnly = x;
        }
        ...
        private void UpdatePonude()
        {
            ...
            string sql = "UPDATE ponude SET " +
                ...
                " napomena='" + ispravi(rtbNapomena.Text) + "'" +
