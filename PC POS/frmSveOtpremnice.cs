...
namespace PCPOS
{
    public partial class frmSveOtpremnice : Form
    {
        ...
        public Robno.frmFakturaBezRobe fakturaBezRobe { get; set; }
        ...
        private void btnUrediSifru_Click(object sender, EventArgs e)
        {
            ...
            if (dgv.RowCount != 0)
            {
                ...
                if (fakturaBezRobe != null)
                {
                    fakturaBezRobe.otpremnica = new string[3] { broj, dgv.CurrentRow.Cells["Godina"].Value.ToString(), dgv.CurrentRow.Cells["Skladište"].Value.ToString() };
                    this.Show();
                }
                else
                {
                    if (this.MdiParent != null)
                    {
                        ...
                        childForm.skladiste_edit = dgv.CurrentRow.Cells["Skladište"].Value.ToString();
        ...
        private void btnIspisBezCijena_Click(object sender, EventArgs e)
        {
            ...
            rfak.dokument = "OTPREMNICA";
            rfak.ImeForme = "Otpremnice";
            rfak.broj_dokumenta = dgv.CurrentRow.Cells["Broj otpremnice"].FormattedValue.ToString();
            rfak.skladiste = dgv.CurrentRow.Cells["Skladište"].FormattedValue.ToString();
            rfak.ShowDialog();
        }
    }
}